...
def handler(event, context):
    ...
    email_source = os.environ.get(
        "EMAIL_SOURCE"
    )  # TODO: This needs to be an input from the step function.  Maybe as an env var?
    ...
    response = client.send_email(
        Source=email_source,
        Destination={"ToAddresses": [message["From"]]},
        Message={
            "Subject": {"Data": f"re: {message['Subject']}"},
